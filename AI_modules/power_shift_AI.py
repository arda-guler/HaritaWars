...
## Author: arda-guler
##
## This AI module attempts to gain as much power advantage per turn as possible over its neighbours. It's a modified
## version of the opportunist AI.
##
...
##
## As for attacks, it choses to attack the strongest enemy regions that are likely to be captured, to get the power advantage
...
def make_decisions(country, number_of_attacks, points_to_place):
    ...
    if len(power_shift_attacks):
        attack = random.choice(power_shift_attacks)
    else:
